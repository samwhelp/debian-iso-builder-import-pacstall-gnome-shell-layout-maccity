...
REF_WORK_DIR_PATH="${HOME}/work/debian-iso-builder-import-pacstall-gnome-shell-layout-maccity"
...
echo "[Next Step]: cd ~/work/debian-iso-builder-import-pacstall-gnome-shell-layout-maccity/iso-profile
"
echo
