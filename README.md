...
# debian-iso-builder-import-pacstall-gnome-shell-layout-maccity
...
> [debian-iso-builder-import-pacstall-gnome-shell-layout-maccity](https://samwhelp.github.io/debian-iso-builder-import-pacstall-gnome-shell-layout-maccity)
...
| Config |
| ------ |
| [~/.config](https://github.com/samwhelp/debian-iso-builder-import-pacstall-gnome-shell-layout-maccity/tree/main/profile/template/asset/overlay/etc/skel/.config) |
| [/usr/share/glib-2.0/schemas](https://github.com/samwhelp/debian-iso-builder-import-pacstall-gnome-shell-layout-maccity/tree/main/profile/template/asset/overlay/usr/share/glib-2.0/schemas) |
| [/etc/dconf/db/distro.d](https://github.com/samwhelp/debian-iso-builder-import-pacstall-gnome-shell-layout-maccity/tree/main/profile/template/asset/overlay/etc/dconf/db/distro.d) |
...
> clone [debian-iso-builder-import-pacstall-gnome-shell-layout-maccity](https://github.com/samwhelp/debian-iso-builder-import-pacstall-gnome-shell-layout-maccity)

``` sh
git clone https://github.com/samwhelp/debian-iso-builder-import-pacstall-gnome-shell-layout-maccity.git
```


> change dir to `debian-iso-builder-import-pacstall-gnome-shell-layout-maccity`

``` sh
cd debian-iso-builder-import-pacstall-gnome-shell-layout-maccity
```
...
> change dir to `~/work/debian-iso-builder-import-pacstall-gnome-shell-layout-maccity/iso-profile`

``` sh
cd ~/work/debian-iso-builder-import-pacstall-gnome-shell-layout-maccity/iso-profile
```
...
> The resulting ISO file will be placed on `~/work/debian-iso-builder-import-pacstall-gnome-shell-layout-maccity/iso-profile/dist`
